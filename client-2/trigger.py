...
print("____________________________Client 2 ______________________________________")
...
print("Client-2 received current model Current model weights:")
...
print(f"Client 2 sent gradients.")
